...
public class TelaCalc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        num1.setForeground(new java.awt.Color(255, 153, 0));
        ...
        num2.setForeground(new java.awt.Color(255, 153, 0));

        res.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        res.setForeground(new java.awt.Color(255, 153, 0));

        btn_calc.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        btn_calc.setForeground(new java.awt.Color(255, 153, 0));
        btn_calc.setText("=");
    ...
    private void btn_calcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcActionPerformed
        ...
        val_1 = Integer.parseInt( num1.getText());
        val_2 = Integer.parseInt(num2.getText());
        s = val_1 + val_2;
